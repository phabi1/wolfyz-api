...
class BankTransfert implements StrategyInterface
{
    private $settings;
    ...
    public function payment(array $params)
    {
        ...
        $paymentUrl = $this->settings->get('wolf_billing_bank_transfer_instruction_page');
    ...
    {
        // Implement callback logic for bank transfer payment here
    }
}