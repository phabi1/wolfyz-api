...
return [
    ...
    'wolf-billing.use_case.create_payment' => [
        'class' => \App\Billing\UseCase\CreatePaymentUseCase::class,
        'arguments' => ['@wolf-billing.payment_manager'],
        'tags' => [
            ['name' => 'use_case', 'value' => 'wolf-billing.create_payment']
        ],
        'shared' => false
    ],
    'wolf-billing.use_case.get_payments_by_meta' => [
        'class' => \App\Billing\UseCase\GetPaymentsByMetaUseCase::class,
        'arguments' => ['@entity.manager'],
        'tags' => [
            ['name' => 'use_case', 'value' => 'wolf-billing.get_payments_by_meta']
        ],
        'shared' => false
    ],
    'wolf-billing.use_case.add_payment' => [
        'class' => \App\Billing\UseCase\AddPaymentUseCase::class,
        'arguments' => ['@entity.manager'],
        'tags' => [
            ['name' => 'use_case', 'value' => 'wolf-billing.add_payment']
        ],
        'shared' => false
    ]
];