...
<?php $this->layout()->startBlock('title'); ?>Demande approuvée<?php $this->layout()->endBlock('title'); ?>
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin: 28px auto;"><tr><td align="center" bgcolor="#9e1c1c" style="border-radius: 10px;">
    <a href="<?php echo $paymentUrl; ?>" style="display: inline-block; padding: 14px 28px; font-size: 16px; font-weight: bold; color: #ffffff; text-decoration: none; border-radius: 10px;">Payer maintenant</a>
</td></tr></table>
